...
<div class="hero">
  <div>
    ...
    <p class="lead">Freshly Baked Cakes & Desserts Just for You</p>
  ...
  <div class="row g-2 align-items-center mb-3">
    ...
    <div class="col-12 col-lg-6 d-flex justify-content-lg-end">
      <ul class="nav nav-pills" id="categoryPills">
        ...
        <li class="nav-item"><button class="nav-link" data-category="cake">Cakes</button></li>
        <li class="nav-item"><button class="nav-link" data-category="cupcake">Cupcakes</button></li>
        <li class="nav-item"><button class="nav-link" data-category="pastry">Pastries</button></li>
      </ul>
    </div>
  </div>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body row g-3">
        <div class="col-md-6">
          <p>Sweet Bliss started with a dream of spreading joy through desserts. From hand-crafted cakes to delicate pastries, every item is made with love and premium ingredients.</p>
        </div>
        <div class="col-md-6">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div id="cartFilled" class="d-none">
          ...
          <a href="https://docs.google.com/forms/d/e/1FAIpQLScNQD9BsIZTY6y0JmHuIPEGaiW-Fn5F86CmXy8im6WopbjdvQ/viewform?usp=header_link" target="_blank" rel="noopener">
...
<script>
  // ====== Data ======
  const cakes = [
    { id: 'choc-fudge', title: 'Chocolate Fudge Cake', desc: 'Rich and moist chocolate delight topped with ganache.', img: 'cakes/Chocolate Fudge Cake.jpg', cat: 'cake', price: 699 },
    { id: 'vanilla-cupcakes', title: 'Vanilla Cupcakes', desc: 'Fluffy vanilla cupcakes with whipped cream frosting.', img: 'cakes/Vanilla Cupcakes.WEBP', cat: 'cupcake', price: 299 },
    { id: 'macarons', title: 'Colorful Macarons', desc: 'A mix of fruity and creamy flavors that melt in your mouth.', img: 'cakes/Colorful Macarons.WEBP', cat: 'pastry', price: 349 },
    { id: 'red-velvet', title: 'Red Velvet Cake', desc: 'A classic with rich cream cheese frosting.', img: 'cakes/Red Velvet Cake.jpeg', cat: 'cake', price: 799 },
    { id: 'strawberry-cheesecake', title: 'Strawberry Cheesecake', desc: 'Creamy cheesecake topped with fresh strawberries.', img: 'cakes/Strawberry Cheesecake.webp', cat: 'cake', price: 749 },
    { id: 'carrot-cake', title: 'Carrot Cake', desc: 'Moist carrot cake with walnut bits and cream cheese frosting.', img: 'cakes/Carrot Cake.jpeg', cat: 'cake', price: 599 },
    { id: 'lemon-drizzle', title: 'Lemon Drizzle Cake', desc: 'Tangy lemon flavor with a sweet glaze.', img: 'cakes/Lemon Drizzle Cake.jpeg', cat: 'cake', price: 549 },
    { id: 'lava-cake', title: 'Chocolate Lava Cake', desc: 'Soft cake with a gooey chocolate center.', img: 'cakes/Chocolate Lava Cake.jpeg', cat: 'cake', price: 399 },
    { id: 'tiramisu-cup', title: 'Tiramisu Cup', desc: 'Coffee-flavored Italian dessert in a cup.', img: 'cakes/Tiramisu Cup.WEBP', cat: 'pastry', price: 459 },
    { id: 'birthday-sprinkle', title: 'Birthday Sprinkle Cake', desc: 'Fun and colorful cake with buttercream frosting.', img: 'cakes/Birthday Sprinkle Cake.jpeg', cat: 'cake', price: 699 },
  ];
  ...
  document.getElementById('checkoutBtn').addEventListener('click', () => {
    alert('redirecting to a new page, wanna go ahead?');
  });
